      ...
      <div class="row">
        <div class="col-3 bg-dark">
         ...
         <div class="col-9 bg-light">
          <h2 class="text-center pt-3 text-danger"> Add Central Sceams</h2>

          <form>
            <div class="form-group ml-4 mt-4">
              <label for="formGroupExampleInput">Sceame Name :-</label>
              <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Input Sceame Name">
            </div>
            <div class="form-group ml-4 mt-4">
              <label for="formGroupExampleInput">Sceame Decription :-</label>
              <textarea type="text" class="form-control" id="formGroupExampleInput" placeholder="Write Your Sceame Decription" rows="8"></textarea>
            </div>
             <div class="form-group ml-4 mt-4">
              <label for="formGroupExampleInput">Sceame link :-</label>
              <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Input Sceame Link">
            </div>
            <div class="form-group ml-4 mt-4">              
              <input type="button" name="" class="btn btn-primary" value="Update Sceame">
            </div>
          </form>
