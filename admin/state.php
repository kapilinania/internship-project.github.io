  ...
  <body>
   ...
   <?php
    ...
    include_once('../connection.php');
        ...
        if ($scame_na!="" && $scame_dec!="" && $scame_link!="")

        {
      $state="INSERT INTO state_sceame SET sceame_name='$scame_na' , sceame_dec='$scame_dec' , sceame_link='$scame_link'";
        ...
        <div class="col-3 bg-dark">
         ...
         <div class="col-9 bg-light">
          ...
          <form method="POST">
            ...
            <div class="form-group ml-4 mt-4">              
              <input type="button" name="login" class="btn btn-primary" value="Update Sceame" onclick="submit()">
            </div>
          </form>
        </div>
